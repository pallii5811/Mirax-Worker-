  ...
  "inline-flex items-center rounded-full border px-3 py-1 text-[11px] font-semibold uppercase tracking-wide",
  {
    variants: {
      variant: {
        ...
        shopify:
          "border-violet-400/25 bg-violet-400/10 text-violet-100 shadow-[0_0_18px_rgba(167,139,250,0.12)]",
        squarespace:
          "border-fuchsia-400/20 bg-fuchsia-400/10 text-fuchsia-100 shadow-[0_0_18px_rgba(232,121,249,0.10)]",
        custom:
          "border-white/10 bg-white/[0.02] text-slate-300",
        insta_missing:
          "border-[rgba(245,158,11,0.4)] bg-[linear-gradient(45deg,rgba(245,158,11,0.2),rgba(168,85,247,0.2))] text-[#fbbf24]",
        expiring_soon:
